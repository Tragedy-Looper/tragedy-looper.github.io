...
If you add a new incident in an `incident.json` it will only be recognized in the tragedy set after regenerating the schemas agin (with the above commands) and change to the dev schema at the top of the file.
